...
export const MATCHES_SEED: RawMatchSeed[] = [
  ...
  // --- Grupo C ---
  { id: 'C1', group_name: 'C', home_team_id: 'BRA', away_team_id: 'MAR', home_score: 2, away_score: 0, match_date: '13/06/2026', match_time: '16:00', stadium: 'SoFi Stadium, Los Angeles', status: 'completed' },
  { id: 'C2', group_name: 'C', home_team_id: 'HAI', away_team_id: 'SCO', home_score: 0, away_score: 3, match_date: '14/06/2026', match_time: '18:00', stadium: 'Hard Rock Stadium, Miami', status: 'completed' },
  { id: 'C3', group_name: 'C', home_team_id: 'BRA', away_team_id: 'HAI', home_score: 4, away_score: 0, match_date: '19/06/2026', match_time: '21:00', stadium: "Levi's Stadium, São Francisco", status: 'completed' },
  { id: 'C4', group_name: 'C', home_team_id: 'SCO', away_team_id: 'MAR', home_score: 1, away_score: 2, match_date: '20/06/2026', match_time: '14:00', stadium: 'NRG Stadium, Houston', status: 'completed' },
  ...
  { id: 'C6', group_name: 'C', home_team_id: 'MAR', away_team_id: 'HAI', match_date: '26/06/2026', time: '20:00', stadium: 'Mercedes-Benz Stadium, Atlanta', status: 'upcoming' },
